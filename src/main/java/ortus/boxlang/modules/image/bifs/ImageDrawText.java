...
public class ImageDrawText extends BIF {
	...
	public ImageDrawText() {
		...
		declaredArguments = new Argument[] {
		    ...
		    new Argument( true, "string", KeyDictionary.str, Set.of( Validator.REQUIRED, Validator.NON_EMPTY ) ),
	...
	public BoxImage _invoke( IBoxContext context, ArgumentsScope arguments ) {
		...
		IStruct		attr		= arguments.getAsStruct( KeyDictionary.attributeCollection );

		if ( attr == null ) {
			return theImage.drawText(
			    StringCaster.cast( arguments.get( KeyDictionary.str ) ),
