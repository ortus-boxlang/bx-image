...
public class ImageDrawBeveledRect extends BIF {
	...
	/**
	 * Draws a beveled rectangle on the image at the specified position and dimensions.
	 *
	 ...
	 *
	 * @argument.raised Whether the bevel appears raised (true) or indented (false).
	 *
